...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default="/nfs/home/haiphung106/DCNet/configs/CIS-R50.yaml",
        metavar="FILE",
...
def visualize_instances(image, predictions):
...
if __name__ == "__main__":
    ...
    if args.input:
        ...
        for path in tqdm.tqdm(args.input, disable=not args.output):
            ...
            # Update visualization to show masks
            visualized_output = visualize_instances(img, predictions)
