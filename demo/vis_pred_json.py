...
from ..mask2camouflage.data.datasets.register_cis import register_dataset
...
if __name__ == '__main__':
    datasets = {
        "my_data_test_coco_cod_style": [
            '/nfs/home/haiphung106/DCNet/pool/COD10K/test2026.json',
            '/nfs/home/haiphung106/DCNet/pool/COD10K/Test_Image_CAM/'
        ],
        "my_data_test_coco_nc4k_style": [
            '/nfs/home/haiphung106/DCNet/pool/NC4K/nc4k_test.json',
            '/nfs/home/haiphung106/DCNet/pool/NC4K/test/image/'
        ]
    }
